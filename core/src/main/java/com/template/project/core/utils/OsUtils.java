package com.template.project.core.utils;
...
public class OsUtils {
    ...
    /**
     * Get the application version. This is also what can be seen in AndroidManifest.xml file.
    ...
    public static String getDeviceModel() {
        // Use MANUFACTURER and PRODUCT because MODEL can return different value like a IME number or any String
